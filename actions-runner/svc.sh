...
SVC_NAME="actions.runner.sherylann-hc-vault-action-snapshot.vault-snapshot"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (sherylann-hc-vault-action-snapshot.vault-snapshot)"
